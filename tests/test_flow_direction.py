...
def raster_file_path():
    """Test fixture that creates a 5X5 raster with random float32 data and returns the path to the file.
        checks for properly assigned stepest descent gradient and no data values assigned to pits
